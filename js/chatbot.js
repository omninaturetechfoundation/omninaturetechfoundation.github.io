...
const OPENAI_API_KEY = "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";
...
function sendChatMessage(message) {
  ...
  fetch(OPENAI_API_ENDPOINT, {
    ...
    .then((data) => {
      ...
      addChatMessage("Neophilic", chatbotResponse);
      loadingElement.style.display = "none";
    })
    .catch((error) => {
      console.error(error);
      addChatMessage("Neophilic", "Sorry, I was unable to process your request.");
      loadingElement.style.display = "none";
    });
}
